...
import pe.gob.trabajo.config.audit.AuditEventConverter;
import pe.gob.trabajo.domain.PersistentAuditEvent;
...
import static pe.gob.trabajo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
