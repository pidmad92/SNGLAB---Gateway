...
public class EmpresaBean implements Serializable {
  ...
  public EmpresaBean(String cod_dep, String cod_dist, String cod_prov, String ddp_ciiu, String ddp_doble,
      String ddp_estado, String ddp_fecact, String ddp_fecalt, String ddp_fecbaj, String ddp_flag22, String ddp_identi,
      String ddp_inter1, String ddp_lllttt, String ddp_mclase, String ddp_nombre, String ddp_nomvia, String ddp_nomzon,
      String ddp_numer1, String ddp_numreg, String ddp_numruc, String ddp_reacti, String ddp_refer1, int ddp_secuen,
      String ddp_tamano, String ddp_tipvia, String ddp_tipzon, String ddp_tpoemp, String ddp_ubigeo, String ddp_userna,
      String desc_ciiu, String desc_dep, String desc_dist, String desc_estado, String desc_flag22, String desc_identi,
      String desc_numreg, String desc_prov, String desc_tamano, String desc_tipvia, String desc_tipzon,
      String desc_tpoemp, boolean esActivo, boolean esHabido) {
  ...
  /**
   * @return the desc_sectoeco
   */
  public String getDesc_sectoeco() {
    return desc_sectoeco;
  }

  /**
   * @param desc_sectoeco the desc_sectoeco to set
   */
  public void setDesc_sectoeco(String desc_sectoeco) {
    this.desc_sectoeco = desc_sectoeco;
  }
