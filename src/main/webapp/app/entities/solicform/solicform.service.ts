...
export class SolicformService {
    ...
    private resourceUrl = SERVER_API_URL + this.resourceDictamenes +  'api/solicforms';
    private resourceSearchUrl = SERVER_API_URL + this.resourceDictamenes + 'api/_search/solicforms';
    ...
    obtenerlistaFormulariosObligatorios(flgObligatorio: number, nCodsolic: number): Observable<ResponseWrapper> {
        ...
        const url = SERVER_API_URL + this.resourceDictamenes + 'api/obtenerDatosFormulario';
    ...
    obtenerSolicitudFormulario(codFormPerfil: number): Observable<Solicform> {
        const options = createRequestOption();
        const url = SERVER_API_URL + this.resourceDictamenes + 'api/obtenerSolicitudFormulario';
