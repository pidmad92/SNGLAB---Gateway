        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.direccionService.find(id).subscribe((direccion) => {
                    direccion.tFecreg = this.datePipe
                        .transform(direccion.tFecreg, 'yyyy-MM-ddTHH:mm:ss');
                    direccion.tFecupd = this.datePipe
                        .transform(direccion.tFecupd, 'yyyy-MM-ddTHH:mm:ss');
