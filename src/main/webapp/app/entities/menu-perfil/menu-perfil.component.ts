...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/menu-perfil'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: MenuPerfil) {
        return item.id;
    }
    registerChangeInMenuPerfils() {
        this.eventSubscriber = this.eventManager.subscribe('menuPerfilListModification', (response) => this.loadAll());
    }
