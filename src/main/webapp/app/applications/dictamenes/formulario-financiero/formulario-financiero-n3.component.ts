...
@Component({
    selector: 'jhi-formulario-financiero-n3',
    templateUrl: './formulario-financiero-n3.component.html',
    styleUrls: ['formulario-financiero.scss']
})

export class FormularioFinancieroN3Component implements OnInit, OnDestroy {
