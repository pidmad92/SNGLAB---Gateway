...
@Component({
    selector: 'jhi-formulario-financiero-anexo2b',
    templateUrl: './formulario-financiero-anexo2b.component.html',
    styleUrls: ['formulario-financiero.scss']
})

export class FormularioFinancieroAnexo2BComponent implements OnInit, OnDestroy {
