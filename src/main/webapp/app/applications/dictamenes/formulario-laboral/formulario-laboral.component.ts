...
import { FormularioLaboralService } from './index';
...
@Component({
    selector: 'jhi-formulario-laboral',
    templateUrl: './formulario-laboral.component.html',
    styleUrls: ['formulario-laboral.scss']
})

export class FormularioLaboralComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private formularioLaboralService: FormularioLaboralService,
