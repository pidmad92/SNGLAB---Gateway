...
@Component({
    selector: 'jhi-formulario-financiero-privado-anexo2a',
    templateUrl: './formulario-financiero-privado-anexo2a.component.html',
    styleUrls: ['formulario-financiero-privado.scss']
})

export class FormularioFinancieroPrivadoAnexo2AComponent implements OnInit, OnDestroy {
