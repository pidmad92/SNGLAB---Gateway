...
@Component({
    selector: 'jhi-formulario-financiero-privado-anexo1a',
    templateUrl: './formulario-financiero-privado-anexo1a.component.html',
    styleUrls: ['formulario-financiero-privado.scss']
})

export class FormularioFinancieroPrivadoAnexo1AComponent implements OnInit, OnDestroy {
