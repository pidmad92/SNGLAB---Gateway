...
@Component({
    selector: 'jhi-formulario-financiero-privado-anexo2c',
    templateUrl: './formulario-financiero-privado-anexo2c.component.html',
    styleUrls: ['formulario-financiero-privado.scss']
})

export class FormularioFinancieroPrivadoAnexo2CComponent implements OnInit, OnDestroy {
    ...
    guardarFormulario() {
        this.formfinancdetalleService.desactivarFormulario(this.nCodffina, 'f2anex2c').subscribe(
            (res: ResponseWrapper) => {
