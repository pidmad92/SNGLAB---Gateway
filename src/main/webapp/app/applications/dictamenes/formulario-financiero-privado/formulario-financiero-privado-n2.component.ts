...
@Component({
    selector: 'jhi-formulario-financiero-privado-n2',
    templateUrl: './formulario-financiero-privado-n2.component.html',
    styleUrls: ['formulario-financiero-privado.scss']
})

export class FormularioFinancieroPrivadoN2Component implements OnInit, OnDestroy {
