...
@Component({
    selector: 'jhi-formulario-financiero-privado-n1',
    templateUrl: './formulario-financiero-privado-n1.component.html',
    styleUrls: ['formulario-financiero-privado.scss']
})

export class FormularioFinancieroPrivadoN1Component implements OnInit, OnDestroy {
    ...
    guardarFormulario() {
        this.formfinancdetalleService.desactivarFormulario(this.nCodffina, 'f1').subscribe(
            (res: ResponseWrapper) => {
