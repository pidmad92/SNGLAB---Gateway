...
import { Formulario2B } from './formulario2B.model';
...
@Component({
    selector: 'jhi-formulario-financiero-financiero-n2b',
    templateUrl: './formulario-financiero-financiero-n2b.component.html',
    styleUrls: ['formulario-financiero-financiero.scss']
})

export class FormularioFinancieroFinancieroN2BComponent implements OnInit, OnDestroy {
    ...
    construirFormulario() {
        this.formulario = new Formulario2B();
    }
