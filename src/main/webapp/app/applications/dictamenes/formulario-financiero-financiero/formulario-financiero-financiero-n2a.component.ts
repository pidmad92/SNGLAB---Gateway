...
import { Formulario2A } from './formulario2a.model';
...
@Component({
    selector: 'jhi-formulario-financiero-financiero-n2a',
    templateUrl: './formulario-financiero-financiero-n2a.component.html',
    styleUrls: ['formulario-financiero-financiero.scss']
})

export class FormularioFinancieroFinancieroN2AComponent implements OnInit, OnDestroy {
    ...
    construirFormulario() {
        this.formulario = new Formulario2A();
    }
