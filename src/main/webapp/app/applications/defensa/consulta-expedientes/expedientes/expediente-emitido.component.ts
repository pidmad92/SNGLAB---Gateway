...
@Component({
    ...
    templateUrl: './expediente-emitido.component.html'
})
export class ExpedienteEmitidoComponent implements OnInit {
    ...
    AsignarDocumento() {
        ...
        this.router.navigate(['/defensa/expediente/consulta', 'exp-emitidos', { outlets: { popupdoc: 'documento/' + this.id } }]);
        console.log('iddoc: ' + this.id);
    }

    ConsultaExpediente() {
        this.id = this.idconciliacion;
        this.router.navigate(['/defensa/expediente/consulta', 'exp-emitidos', { outlets: { popupexpe: this.id } }]);
