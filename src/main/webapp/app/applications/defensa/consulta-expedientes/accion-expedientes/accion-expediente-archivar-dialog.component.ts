...
@Component({
    selector: 'jhi-accion-expediente-archivar-dialog',
    templateUrl: './accion-expediente-archivar-dialog.component.html'
})
export class AccionExpedienteArchivarDialogComponent implements OnInit {
...
export class AccionExpedienteArchivarPopupComponent implements OnInit, OnDestroy {
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if ( params['id'] ) {
                this.accionExpedienteArchivarPopupService
                    .open(AccionExpedienteArchivarDialogComponent as Component, params['id']);
            } else {
                this.accionExpedienteArchivarPopupService
                    .open(AccionExpedienteArchivarDialogComponent as Component);
            }
        });
    }
